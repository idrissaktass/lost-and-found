...
const cors = Cors({
  origin: 'https://lost-and-found-frontend-mu.vercel.app/listing',
...
export default async function handler(req, res) {
  ...
  if (req.method === 'OPTIONS') {
    res.setHeader('Access-Control-Allow-Origin', 'https://lost-and-found-frontend-mu.vercel.app/listing');

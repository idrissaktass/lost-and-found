...
router.get('/:username/:recipient', async (req, res) => {
    ...
    console.log("RrecipientUsername", username);
...
router.get('/:username/unread', async (req, res) => {
    const username = req.params.username;
    console.log("Received request for unread messages for user:", username);
...
router.get('/:username', async (req, res) => {
    const username = req.params.username;
    console.log("Received request for messages for user:", username);
